...
const projects = [
  ...
  { id: "toa-notes", title: "Theory of Algorithms — Interactive Notes & Practice", category: "academic", date: "Dec 2025 - Present", badge: "Academic", desc: "An interactive study platform for Theory of Algorithms featuring structured summary notes, interactive exercises for key topics, and guided practice. Currently developing a practical exam simulator where users can submit answers, receive automated marking, and access solution memos after a limited number of attempts.", tags: ["HTML", "JavaScript", "Interactive Learning"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }], links: [{ label: "Website", url: "https://to-a.vercel.app/" }], shade: "academic" },
  { id: "toc-notes", title: "Theory of Computation — Detailed Study Notes", category: "academic", date: "Dec 2025 - Jan 2026", badge: "Academic", desc: "A structured set of detailed study notes for Theory of Computation designed to support exam preparation and concept understanding. The material focuses on clear explanations of core theoretical concepts and serves as a comprehensive study reference.", tags: ["HTML", "Technical Writing", "Computer Science Theory"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }], links: [{ label: "Website", url: "https://to-a.vercel.app/" }], shade: "academic" },
  { id: "vea", title: "VEA – Violence Ending Agent", category: "project", date: "Dec 2025", badge: "AI Safety Platform", desc: "A confidential AI-driven platform designed to support survivors of gender-based violence through structured, empathetic chat interactions. The system provides guided emotional support, real-time crisis keyword detection, and safe escalation to trained professionals. It also enables moderated peer support connections while maintaining strong privacy protections and offline fallback functionality for accessibility.", tags: ["React.js", "Node.js", "AI Chat Systems", "Crisis Detection", "Privacy-first Design"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }, { name: "Jawahier Achmat", link: "https://www.linkedin.com/in/jawahier-achmat-783bbb267/" }, { name: "Nikita Martin", link: "https://www.linkedin.com/in/nikita-martin-17905630a/" }, { name: "Nooriya Shaik", link: "https://www.linkedin.com/in/nooriya-shaik-bab7b8364/" }], links: [{ label: "Source", url: "https://github.com/Plum165/Code-the-Halls-" }], shade: "hackathon" },
  ...
  { id: "ussd-interledger", title: "USSD + Interledger Payment App", category: "hackathon", date: "23 - 28 June 2025", badge: "🏆 2nd Place", desc: "Offline-first payments via USSD integrated with Interledger Open Payments, enabling cross-border transactions without persistent internet.", tags: ["Node.js", "USSD", "Interledger", "Express"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }, { name: "Sakeenah Majiet", link: "https://www.linkedin.com/in/ACoAADnntV4Bu4s9XL59yet_ghTXc0gIJKTWYg4" }, { name: "Amukelani Rikhotso", link: "https://www.linkedin.com/in/ACoAAEDuoWQBcswkg52H4swWa25VI2PhzCwnGrU" }, { name: "Raibim Alam", link: "https://www.linkedin.com/in/ACoAADT8U7YBeUA3iE9Gs7QI6G7H5NQfi1DiudY" }, { name: "Lateef Ahmed", link: "https://www.linkedin.com/in/ACoAAFnr23UB48-o4BWkMNPH632oUpalqVTN1uQ" }], links: [{ label: "Source", url: "https://github.com/Plum165/FinTechHackthon" }], shade: "hackathon" },
  { id: "page-replacement", title: "Page Replacement Simulator", category: "coursework", date: "21 Jun 2025", badge: "Coursework", desc: "Java implementation of FIFO, LRU, Optimal, and Clock page replacement algorithms with visualizations.", tags: ["Java", "Algorithms", "OS"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }], links: [{ label: "Source", url: "https://github.com/Plum165/PgAlgo" }], shade: "coursework" },
  ...
  { id: "torrent-simulator", title: "Simplified Torrent-like File Sharing", category: "coursework", date: "24 Feb - 18 Mar 2025", badge: "Networking", desc: "A Python-based P2P file sharing simulation to teach networking principles. Includes a tracker for peer discovery and supports both TCP and UDP.", tags: ["Python", "TCP/UDP Sockets", "Multithreading"], contributors: [{ name: "Moegamat Samsodien", link: "https://linkedin.com/in/moegamatsamsodien" }, { name: "Aneesah Barnes", link: "https://www.linkedin.com/in/aneesah-barnes-724143237" }, { name: "Marcus Buxmann", link: "https://www.linkedin.com/in/marcus-buxmann-a63690258/" }], links: [{ label: "Source", url: "https://github.com/Plum165/Simplified-torrent-like-file-sharing" }], shade: "coursework" },
